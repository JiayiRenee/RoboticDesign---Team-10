...
def generate_launch_description():
    ...
    # Include node to spawn the robot and launch rviz, pass through use sim time argument
    launch_rover = IncludeLaunchDescription(
    PythonLaunchDescriptionSource([get_package_share_directory('node'), '/launch', '/rover.launch.py']),
    launch_arguments={
